...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> EntityProjectExcludedCoreProjectFolder =
        CVarDef.Create("autogen.entity_project.excluded_core_project_folder", "_Corvax", CVar.ARCHIVE);
    ...
    public static readonly CVarDef<string> WikiProjectPrefix =
        CVarDef.Create("autogen.wiki.project_prefix", "Goob", CVar.SERVERONLY | CVar.ARCHIVE);
}
