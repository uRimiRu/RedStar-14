...
job-description-botanist = Выращивайте фрукты и овощи для поваров, лекарственные травы для медотсека, и другие растения для личного пользования.
job-description-borg = Получеловек, полумашина. Придерживайтесь своих законов, служите экипажу и преследуйте научных сотрудников с просьбами об апгрейде.
job-description-boxer = Пробейтесь на вершину! Бросьте вызов начальнику отдела кадров и будьте арестованы, когда выиграете. Эта должность доступна на станциях Core, Avrite и Convex.
job-description-brigmedic = Боритесь за жизни своих товарищей в тылу милиции! Вы - первая и последняя надежда своего отряда. Да благословит вас Гиппократ.
...
job-description-centcomoff = Выступайте в роли посла на новейшей ультрасовременной космической станции в составе флота СССП.
...
job-description-ertleader = Возглавьте отряд быстрого реагирования для устранения угрозы активам компании СССП.
...
job-description-hos = Управляйте своими сотрудниками милиции и следите за их эффективностью, подавляйте инакомыслие и обеспечивайте безопасность других глав.
...
job-description-qm = Руководите отделом снабжения станции, контролируйте работу шахтёров, следите за выполнением всех заказов и обеспечивайте поступление денег.
...
job-description-salvagespec = Используйте магнит для притягивания обломков кораблей и астероидов на разграбление с целью обогащения станции. Постройте шаттл шахтёров, чтобы летать на другие планеты, попутно отбиваясь от космической фауны.
...
job-description-surgeon = Спасайте жизни, мастерски проводите операции, принимайте критические решения и исцеляйте пациентов.
...
job-description-security-clown = Выполняйте работу сотрудников милиции, но с щепоткой клоунской натуры.
