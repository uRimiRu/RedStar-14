...
sec-apartment-ui-footer = СССП™ все права защищены
...
sec-apartment-ui-squads-save-tooltip = Переименовать
sec-apartment-ui-squads-delete = 🗑
sec-apartment-ui-squads-delete-tooltip = Удалить
sec-apartment-ui-squads-status = СТАТУС:
sec-apartment-ui-squads-members = ЧЛЕНЫ ОТРЯДА
sec-apartment-ui-squads-desc-placeholder = Описание отряда...
...
sec-apartment-icon-delta = Дельта
sec-apartment-icon-epsilon = Эпсилон
sec-apartment-icon-zeta = Дзета
sec-apartment-icon-heta = Эта
sec-apartment-icon-theta = Тета
sec-apartment-icon-iota = Йота
sec-apartment-icon-kappa = Каппа
sec-apartment-icon-lambda = Лямбда
sec-apartment-icon-mu = Мю
sec-apartment-icon-nu = Ню
sec-apartment-icon-xi = Кси
sec-apartment-icon-omicron = Омикрон
sec-apartment-icon-pi = Пи
sec-apartment-icon-ro = Ро
sec-apartment-icon-sigma = Сигма
sec-apartment-icon-tau = Тау
sec-apartment-icon-upsilon = Ипсилон
sec-apartment-icon-fi = Фи
...
sec-apartment-ui-timers-remove-tooltip = Удалить таймер из списка
sec-apartment-ui-timers-total-time = Общее время:
