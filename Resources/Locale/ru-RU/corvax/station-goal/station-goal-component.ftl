...
station-goal-artifacts =
    ...
    Каждый документ должен быть подтверждён печатью научного руководителя или капитана. Артефакты с документацией должны быть доставлены на станцию Генерального Штаба.
...
station-goal-bank =
    ...
    Лучшие семена должны быть выбраны и выведены агрономами.
...
station-goal-security =
    ...
    Второстепенная цель — постройка и снабжение тренировочного комплекса для милиции, с последующей проверкой состава.[/bold]
...
station-goal-theatre =
    ...
    В случае проведения тестового представления сервисный отдел станции будет вознагражден по прибытию на Станцию ГШ.
    По окончании работ ГШ может прислать представителя для проведения тестового представления.
...
station-goal-bunker =
    ...
    Необходимо пристроить по комнате, далее именуемой как “бункер”, следующим отделам: милиции, Медицинскому и Командному. В них экипаж станции мог бы укрыться от последствий гиперэнергетических потоков.
    ...
    Бункер отдела милиции должен так же включать в себя два Силовика и три Раздатчика летальных ружейных патронов.
...
station-goal-frame-repair =
    ...
    Необходимо достроить каждому отделу помещения, необходимые для успешной их работы. Также необходимо построить кухню и гидропонику для сервисного отдела, оружейную и место содержания заключённых для отдела милиции, обеспечить свободный проход пассажиров станции до отбытия, без необходимости выхода в открытый космос.
    
    Для помощи в выполнении цели Генеральный Штаб будет каждые пять минут высылать припасы на специальной посадочной площадке в центре станции.
...
station-goal-astra-repair =
    ...
    Вам необходимо силами утилизаторов и милиции при необходимости (по запросу утилизаторов) избавиться от мешающей проведению работ враждебной фауны.
...
station-goal-bluespace-harvest =
    { station-goal-start }[bold]
    Второстепенная цель { $station } — создание и тестирование на перегрузку экспериментального блюспейс-добытчика.[/bold]
