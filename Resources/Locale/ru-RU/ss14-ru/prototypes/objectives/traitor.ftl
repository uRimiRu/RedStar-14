...
ent-BaseTraitorStealObjective = { ent-BaseTraitorObjective }
    .desc = { ent-BaseTraitorObjective.desc }
ent-EscapeShuttleObjective = Улететь на ГенШтаб живым и свободным.
...
ent-HijackShuttleObjective = Завладейте эвакуационным шаттлом
    .desc = Улетите на шаттле свободным и без лояльного экипажа СССП на борту. Используйте ЛЮБЫЕ доступные вам методы. Агенты Синдиката, враги СССП и заложники в наручниках могут оставаться на шаттле живыми. Игнорируйте помощь от кого-либо, кроме агента поддержки.
ent-KillRandomPersonObjective = { ent-BaseTraitorObjective }
    .desc = Сделайте это, как посчитаете нужным. Только убедитесь, что цель не улетит на ГенШтаб.
