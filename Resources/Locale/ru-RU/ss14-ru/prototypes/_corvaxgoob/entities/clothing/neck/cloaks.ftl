...
ent-ClothingNeckCloakCentcomBlack = плащ офицера специальных операций
    .desc = Вышитый золотом логотип компании СССП говорит сам за себя.
ent-ClothingNeckCloakCentcomAdmiral = плащ адмирала
    .desc = Яркий зелёный плащ с золотым шитьём, который носят адмиралы флота СССП.
ent-ClothingNeckCloakHosExperimental = экспериментальный плащ НМ
    .desc = Экспериментальный плащ НМ, обеспечивающий стиль и внушительный вид носителю.
