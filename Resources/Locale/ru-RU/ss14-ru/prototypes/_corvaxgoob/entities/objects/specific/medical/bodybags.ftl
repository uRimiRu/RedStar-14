...
ent-BodyBagBluespaceFolded = { ent-BodyBagBluespace }
    ...
    .suffix = Сложенный
ent-BodyBagNanoTrasen = зелёный мешок для тела
    .desc = Вещмешок Магнолия с эмблемой ГенШтаба, предназначенный для хранения и транспортировки груза, и предотвращения их гниения.
    .suffix = ГенШтаб
ent-BodyBagNanoTrasenFolded = { ent-BodyBagNanoTrasen }
    .desc = { ent-BodyBagNanoTrasen.desc }
    .suffix = Сложенный, ГенШтаб
