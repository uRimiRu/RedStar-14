ent-CrowbarAbductor = инопланетная монтировка
    .desc = Изготовлен из металла, более прочного, чем все, о чем могли мечтать в СССП.
...
ent-ScrewdriverAbductor = инопланетная отвёртка
    .desc = Более эффективный, чем все, о чем мог мечтать СССП. Не путать со звуковой отвёрткой.
