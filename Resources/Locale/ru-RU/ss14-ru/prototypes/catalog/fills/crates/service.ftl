ent-CrateServiceJanitorialSupplies = ящик с уборочным инвентарём
    .desc = Победите копоть и грязь с Незаменимыми Припасами для Уборки от СССП! Содержит три ведра, таблички мокрого пола и очищающие гранаты. Также содержит одну швабру, тряпку, щётку, чистящий спрей и мусорный пакет.
