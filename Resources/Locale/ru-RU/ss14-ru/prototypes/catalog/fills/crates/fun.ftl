...
ent-CrateFunInstrumentsSpecial = набор специальных коллекционных инструментов
    .desc = Поднимите шум при помощи этой специальной коллекции почти-инструментов! ГенШтаб не несёт ответственности за любые травмы, вызванные содержимым ящика.
