...
ent-ClothingUniformEnvirosuitDetective = экокостюм следователя
    .desc = Проект для особенно изысканного плазмалюда, модифицированный NanoTrasen для следователей.
ent-ClothingUniformEnvirosuitHoP = экокостюм главы персонала
    .desc = Экокостюм для плазмалюда, занимающего пост «Начальник отдела кадров».
ent-ClothingUniformEnvirosuitHoS = экокостюм НМ
    .desc = Контейнерный костюм для плазмалюдов, занявших должность начальника милиции.
ent-ClothingUniformEnvirosuitHydroponics = экокостюм агронома
...
ent-ClothingUniformEnvirosuitCentcomAgent = экокостюм агента ГенШтаб
    .desc = Экокостюм для юридической команды CentCom. Пахнет сгоревшим кофе.
ent-ClothingUniformEnvirosuitCentcomOfficial = экокостюм представителя ГенШтаб
    .desc = Экокостюм для официальных лиц CentCom.
ent-ClothingUniformEnvirosuitCentcomOfficer = экокостюм офицера ГенШтаб
...
ent-ClothingUniformEnvirosuitReporter = экокостюм корресподента
...
ent-ClothingUniformEnvirosuitQM = экокостюм заведующего хозяйством
...
ent-ClothingUniformEnvirosuitBrigmedic = экокостюм дежурного врача
...
ent-ClothingUniformEnvirosuitEnviroslacksMNKAlt = стильный экокостюм MNK
    ...
    .suffix = Альтернативный
ent-ClothingUniformEnvirosuitEnviroslacksPsychologist = стильный экокостюм психиатра
    .desc = Личный проект особенно щеголеватого плазмалюда, эта версия предназначена для психиатра. Умопомрачительно!
