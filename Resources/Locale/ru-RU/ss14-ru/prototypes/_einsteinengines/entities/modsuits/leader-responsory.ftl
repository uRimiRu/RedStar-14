...
ent-ClothingModsuitHelmetResponsoryLeader = шлем скафандра лидера СОБР
    .desc = Передовой шлем, разработанный Nanotrasen для скафандра лидера СОБР. Имеет встроенный ИЛС.
ent-ClothingModsuitChestplateResponsoryLeader = нагрудная пластина скафандра лидера СОБР
    .desc = Передовой нагрудник, разработанный Nanotrasen для скафандра лидера СОБР. Оснащён сервоприводами для снижения нагрузки.
