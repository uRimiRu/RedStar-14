...
ent-MachineFTLDriveAutomated = БСС двигатель CTLA-2048
    .desc = Блюспейс двигатель для фиксированных транспортных маршрутов. Быстро перезаряжается, но работает только для преднастроенных транспортных маршрутов СССП.
