...
ent-ClothingOuterSuitShrineMaidenReal = наряд служительницы храма
    .desc = { ent-ClothingOuterWizardBase.desc }
ent-ClothingHeadHatCentCommwizardReal = шляпа мага ГШ
    .desc = Безупречная зелёно-золотая шляпа мага, положенная по регламенту тайным агентам Генерального Штаба. Носится только теми, кто уполномочен использовать засекреченные тауматургические инструменты.
    .suffix = АДМИН
ent-ClothingOuterWizardCentCommReal = робы мага ГШ
    .desc = Безупречные зелёно-золотые робы, украшенные самоцветами, положенные по регламенту тайным агентам Генерального Штаба. Носится только теми, кто уполномочен использовать засекреченные тауматургические инструменты.
    .suffix = АДМИН
