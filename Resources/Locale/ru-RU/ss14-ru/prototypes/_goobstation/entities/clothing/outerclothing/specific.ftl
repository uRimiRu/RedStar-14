...
ent-WhiteRobes = роба избранного
    .desc = Эти белые робы носят только лучшие сотрудники СОБР NanoTrasen.
    .suffix = Избранный
...
ent-ClothingOuterSchemaMonk = монашеское облачение
    .desc = Знак полного отречения от мира и принятия схимы. Его носят те, кто избрал путь молитвы и борьбы за человеческую душу. В безмолвии космоса оно выглядит особенно уместно.