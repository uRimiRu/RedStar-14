...
ent-ClothingUniformJumpsuitCentralCommandLiaison = комбинезон представителя Генштаба
    .desc = Ходят слухи, что чиновник, который первым увидел форму Офицера Внешнего Командования, так сильно позеленел от зависти, что и этот комбинезон окрасился в зелёный цвет.
...
ent-ClothingUniformJumpsuitVeteranSecurity = лёгкий комбинезон службы безопасности
    .desc = Облегчённая версия стандартного комбинезона службы безопасности. Обычно выдаётся на смены, когда в отделе атмосферики всё идёт наперекосяк.