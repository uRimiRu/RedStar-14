ent-CentcomAgentSkirt = юбка агента ГенШтаб
    .desc = Юбка, которую носит юридическая команда ГенШтаб. Пахнет сгоревшим кофе.
...
ent-ClothingUniformJumpskirtReporter = платье корресподента
