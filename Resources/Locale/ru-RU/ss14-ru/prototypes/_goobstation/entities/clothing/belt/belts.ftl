...
ent-ClothingBeltDeathsquadWebbing = разгрузка оперативника Эскадрона Смерти
    ...
    .suffix = НЕ МАППИТЬ
ent-ClothingBeltSecurityWebbingMedical = разгрузка врача СОБР
...
ent-ClothingBeltChemBagSyndi = медицинская сумка Синдиката
    .desc = Прочная сумка для медицинских принадлежностей, носимая оперативниками Gorlex Marauders. Пахнет дезоксиэфедрином.
...
ent-ClothingBeltMilitaryRigGrenadier = РПС гренадера
    .desc = Специализированная разгрузка для переноски такого количества гранат, что рука устаёт их бросать. Также может хранить пистолет и магазины к нему.
...
ent-ClothingBeltChemBagXenobiologyHolding = блюспейс-сумка ксенобиолога
...
ent-ClothingBeltSecurityWebbingContractorFilled = { ent-ClothingBeltSecurityWebbingContractor }
    ...
    .suffix = Заполненный
ent-ClothingBeltWhipping = плётка-ремень
    .desc = Была бы плётка, а способ найдётся.
    .suffix = Адмемы
