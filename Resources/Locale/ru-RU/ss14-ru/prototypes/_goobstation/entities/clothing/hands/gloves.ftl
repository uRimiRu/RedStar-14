...
ent-ClothingHandsGlovesHeavyGoldenTrim = тяжёлые перчатки с золотой отделкой
    .desc = Пара перчаток с золотой отделкой для сотрудников Генерального Штаба. Эти изолированы.
ent-ClothingHandsGlovesGoldenTrim = перчатки с золотой отделкой
    .desc = Пара перчаток с золотой отделкой для сотрудников Генерального Штаба. Не изолированы.
...
ent-ClothingHandsKnuckleDustersQM = гравированный кастет заведующего хозяйством
    .desc = Кастет, выкованный лучшими мастерами по заказу заведующего хозяйством, твёрдый и плотный, предназначен для сокрушительных ударов и повреждения внутренних органов несчастной жертвы.
    .suffix = НЕ МАППИТЬ
ent-ClothingHandsKnucklesQuartermaster = гравированный кастет заведующего хозяйством
    .desc = Кастет, выкованный лучшими мастерами по заказу заведующего хозяйством, твёрдый и плотный, предназначен для сокрушительных ударов и повреждения внутренних органов несчастной жертвы.
    .suffix = НЕ МАППИТЬ
