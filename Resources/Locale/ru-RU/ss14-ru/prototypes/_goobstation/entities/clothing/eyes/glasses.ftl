...
ent-ClothingEyesGlassesDeathsquad = очки командующего Эскадрона Смерти
    ...
    .suffix = НЕ МАППИТЬ
ent-ClothingEyesGlassesCentComm = очки ГенШтаба
    .desc = Очки для персонала Генерального Штаба. Ничего личного.
    .suffix = НЕ МАППИТЬ
ent-ClothingEyesGlassesCentCommNoThermal = очки ГенШтаба
    .desc = Пара очков, созданных для персонала Генерального Штаба. Оснащены таким функционалом, чем сложно представить.
