...
ent-ClothingHeadHatArmoredCC = { ent-ClothingHeadBase }
    .desc = { ent-ClothingHeadBase.desc }
ent-ClothingHeadHatBeretEliteNavyOfficer = элитный берет офицера ГенШтаба
    .desc = Тёмно-синий берет с серебряным щитом сил безопасности NanoTrasen.
ent-ClothingHeadHatBeretNavyOfficer = берет офицера ГенШтаба
...
ent-ClothingHeadHatBeretHeadOfSecurityAdvanced = парадный берет начальника милиции
