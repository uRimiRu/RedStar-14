...
ent-MobMothroachMustard = горчичная таракамоль
    .desc = Восхитительный результат скрещивания поварами плоти с соусом.
...
ent-MobMothroachCecropia = цекропиевая таракамоль
    .desc = Очаровательный результат многочисленных попыток скрестить растение из семейства крапивных с тараканами.
ent-MobMothroachLunar = лунная таракамоль
    .desc = Кто-то оставил эту моль под лунным светом.
