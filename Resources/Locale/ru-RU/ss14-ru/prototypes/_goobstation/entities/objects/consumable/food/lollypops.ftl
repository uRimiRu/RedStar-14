...
ent-FoodSnackLollypopWrappedBaseCentcomm = леденец ГШ в обертке
    .desc = Очень дорогой леденец, всё ещё в золотой обертке.
ent-FoodSnackLollypopBaseCentcomm = леденец ГШ
...
ent-FoodSnackLollypopWrappedCentComm = леденец ГШ в обертке
    .desc = Ещё более экстравагантный леденец, всё ещё в обертке.
ent-FoodSnackLollypopCentcomm = леденец ГШ
...
ent-FoodSnackLollypopTrashCentcomm = обёртка от леденца ГШ
