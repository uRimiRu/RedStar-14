...
ent-HandheldFax = ручной факс
    .desc = Инструмент, который может отправлять тонны бумаги на факс ГенШтаб.
ent-HandheldFaxNanorep = ручной факс представителя ГенШтаба
    .suffix = Представителя ГенШтаба
    .desc = { ent-HandheldFax.desc }
ent-HandheldFaxOfficial = ручной факс ГенШтаба
    .suffix = ГенШтаб
    .desc = { ent-HandheldFax.desc }
