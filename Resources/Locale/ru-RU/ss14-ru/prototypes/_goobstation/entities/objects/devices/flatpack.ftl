...
ent-SlotMachineHighRollerFlatPack = упакованная слот-машина заведующего хозяйством
    .desc = Упаковка, при помощи которой можно создать слот-машину заведующего хозяйством.
