...
ent-ActionSlasherMassacre = РЕЗНЯ!
    .desc = Запускает цепочку жестоких атак. Чем больше ударов вы нанесёте по своей жертве, тем больше будет становиться урон. После тринадцатого удара жертва будет обезглавлена.
...
ent-ActionSlasherNightVision = Улучшенное зрение
    .desc = Вы прекрасно видите в темноте.
ent-ActionSlasherRelentlessGrab = Безжалостный захват
