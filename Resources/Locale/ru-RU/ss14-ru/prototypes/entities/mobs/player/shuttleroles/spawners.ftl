...
ent-VisitorCMOSpawner = спавнер посетитель ГВ
    .desc = { ent-MarkerBase.desc }
ent-VisitorHOPSpawner = спавнер посетитель НОК
    .desc = { ent-MarkerBase.desc }
ent-VisitorHOSSpawner = спавнер посетитель НМ
    .desc = { ent-MarkerBase.desc }
...
ent-SecurityVisitorSpawner = спавнер посетитель СБ
    .desc = { ent-MarkerBase.desc }
ent-VisitorSecurityCadetSpawner = спавнер посетитель курсант милиции
    .desc = { ent-MarkerBase.desc }
ent-VisitorSecurityOfficerSpawner = спавнер посетитель офицер СБ
    .desc = { ent-MarkerBase.desc }
ent-VisitorDetective = спавнер посетитель следователь
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorAtmosTechSpawner = спавнер посетитель атмосферный техник
    .desc = { ent-MarkerBase.desc }
ent-VisitorTechnicalAssistantSpawner = спавнер посетитель слесарь
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorChemistSpawner = спавнер посетитель химик
    .desc = { ent-MarkerBase.desc }
ent-VisitorMedicalInternSpawner = спавнер посетитель практикант
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorGeneticistSpawner = спавнер посетитель генетик
    .desc = { ent-MarkerBase.desc }
ent-VisitorPsychologistSpawner = спавнер посетитель психиатр
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorBartenderSpawner = спавнер посетитель бармен
    .desc = { ent-MarkerBase.desc }
ent-VisitorBotanistSpawner = спавнер посетитель агроном
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorLawyerSpawner = спавнер посетитель адвокат
    .desc = { ent-MarkerBase.desc }
ent-VisitorLawyerCentcomSpawner = спавнер посетитель адвокат ГШ
    .desc = { ent-MarkerBase.desc }
...
ent-VisitorMimeSpawner = спавнер посетитель мим
    .desc = { ent-MarkerBase.desc }
ent-VisitorReporterSpawner = спавнер посетитель корресподент
    .desc = { ent-MarkerBase.desc }
ent-VisitorServiceWorkerSpawner = спавнер посетитель сервисный работник
    .desc = { ent-MarkerBase.desc }
ent-VisitorZookeeperSpawner = спавнер посетитель ветеринар
    .desc = { ent-MarkerBase.desc }
...
ent-ChallengeCargoTechnicianSpawner = спавнер челлендж грузчик
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-MarkerBase.desc }
ent-NTVisitorSpawner = спавнер посетитель СССП
    .desc = { ent-MarkerBase.desc }
ent-NTVisitorSpawner50 = спавнер посетитель СССП
    .suffix = 50
    .desc = { ent-MarkerBase.desc }
ent-NTVisitorSpawner33 = спавнер посетитель СССП
    .suffix = 33
    .desc = { ent-NTVisitorSpawner50.desc }
ent-NTVisitorSpawner25 = спавнер посетитель СССП
    .suffix = 25
    .desc = { ent-NTVisitorSpawner50.desc }
ent-NTVisitorSpawner20 = спавнер посетитель СССП
    .suffix = 20
    .desc = { ent-NTVisitorSpawner50.desc }
ent-NTVisitorSpawner10 = спавнер посетитель СССП
    .suffix = 10
    .desc = { ent-NTVisitorSpawner50.desc }
