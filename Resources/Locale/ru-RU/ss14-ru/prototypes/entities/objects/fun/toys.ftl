...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч — один из самых популярных продуктов компании СССП. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' — СССП.
...
ent-BalloonNT = воздушный шарик ГенШтаба
    .desc = Разработан специально для причинения максимального психологического вреда врагам ГенШтаба.
