...
ent-VendingMachineRestockCostumes = набор пополнения ТеатроШкаф
    .desc = Паноптикум сотрудников СССП пестрит в красочной трагикомедии. Присоединяйтесь к ним и вы! Загрузите это в ближайший торгомат ТеатроШкаф.
...
ent-VendingMachineRestockSecTech = набор пополнения СБТех
    .desc = Коммунисты берегитесь: подкрепление прибыло! На этикетке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ милиции".
