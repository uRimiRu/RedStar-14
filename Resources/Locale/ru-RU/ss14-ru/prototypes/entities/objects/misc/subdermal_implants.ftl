...
ent-RadioImplantCentcomm = имплант "радио"
    .desc = Этот имплант даёт доступ к радиочастоте Генерального Штаба без гарнитуры. Использование разрешено только сотрудникам ГШ.
ent-DeathRattleImplantCentcomm = имплант "предсмертный хрип" ГШ
    .desc = Этот имплант сообщит по радиоканалу Генерального Штаба, если пользователь окажется в критическом состоянии или умрёт.
