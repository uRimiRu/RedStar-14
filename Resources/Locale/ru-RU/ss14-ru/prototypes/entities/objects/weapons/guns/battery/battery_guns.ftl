...
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники СОБР Nanotrasen.
    .suffix = Винтовка
...
ent-WeaponDisablerPractice = тренировочный станнер
    .desc = Оружие для самозащиты, которое изнуряет органические цели, пока они не свалятся с ног. Эта модель была урезана для курсантов и практически безвредна.
    .suffix = Пистолет
