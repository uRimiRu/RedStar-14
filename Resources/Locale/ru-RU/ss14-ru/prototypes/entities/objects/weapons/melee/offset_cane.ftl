...
ent-OffsetCaneNT = трость СССП
    .desc = Стандартная трость СССП, со смещённым центром тяжести и логотипом компании. Любима теми, кто предпочитает более корпоративный вид.
