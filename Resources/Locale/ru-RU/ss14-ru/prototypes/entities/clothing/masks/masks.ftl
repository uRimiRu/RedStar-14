...
ent-ClothingMaskGasSecurity = противогаз СБ
    .desc = Стандартный противогаз милиции.
...
ent-ClothingMaskGasCaptain = противогаз капитана
    .desc = В СССП решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
ent-ClothingMaskGasCentcom = противогаз ГШ
