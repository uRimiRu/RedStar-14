...
ent-ClothingNeckLawyerbadge = значок адвоката
    .desc = Значок, свидетельствующий что владелец является "законным" юристом, сдавшим экзамен СССП, необходимый для занятия юридической практикой.
ent-Dinkystar = наклейка-звёздочка
    .desc = Маленькая звёздочка только для самых трудолюбивых сотрудников милиции! Она уже даже не липкая.
