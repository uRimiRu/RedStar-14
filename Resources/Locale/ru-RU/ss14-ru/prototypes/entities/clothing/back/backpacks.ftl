...
ent-ClothingBackpackCaptain = рюкзак капитана
    .desc = Это особый рюкзак, изготавливаемый исключительно для офицеров СССП.
...
ent-ClothingBackpackDeathSquad = рюкзак Эскадрона Смерти
    .desc = Вмещает снаряжение самых устрашающих агентов Генерального Штаба.
...
ent-ClothingBackpackDebug = сумасшедший рюкзак
    .desc = Что это за херня?!
    .suffix = Debug
ent-ClothingBackpackDebug2 = БОЛЬШОЙ сумасшедший рюкзак
    .desc = Что это за херня?!
    .suffix = Debug
ent-ClothingBackpackDebug3 = гейский сумасшедший рюкзак
    .desc = Что это за херня?!
    .suffix = Debug
ent-ClothingBackpackDebug4 = смещающий сумасшедший рюкзак
    .desc = Что это за херня?!
    .suffix = Debug
