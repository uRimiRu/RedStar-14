...
ent-ClothingHeadHatBeretSecurity = берет охраны
    .desc = Стильный вариант одежды для сотрудников милиции.
ent-ClothingHeadHatSecurityTrooper = шляпа патрульного
    .desc = Широкополая шляпа Патрульных СССП, идёт в комплекте с чехлом, но вы его потеряли.
...
ent-ClothingHeadHatBeretQM = берет заведующего хозяйством
    .desc = Берет с эмблемой отдела снабжения. Для заведующих хозяйством, склонных к стилю.
...
ent-ClothingHeadHatBeretBrigmedic = берет дежурного врача
...
ent-ClothingHeadHatBeretCommand = берет командования
    .desc = Берет с логотипом СССП. От него исходит аура власти.
...
ent-ClothingHeadHatCentcom = фирменная шапка ГенШтаб
...
ent-ClothingHeadHatHoshat = шляпа начальника милиции
    .desc = Верная фуражка стандартного образца начальника милиции. Чтобы показать офицерам, кто здесь командует.
...
ent-ClothingHeadHatCentcomcap = фуражка ГенШтаб
    .desc = Экстравагантная, причудливая фуражка офицера Генерального Штаба.
