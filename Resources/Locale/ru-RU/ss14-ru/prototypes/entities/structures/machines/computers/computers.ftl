...
ent-ComputerCriminalRecords = консоль криминальных записей
    .desc = Её можно использовать для проверки судимостей. Редактировать их может только милиция.
...
ent-CentcommComputerComms = консоль связи ГШ
...
ent-ComputerCargoOrdersSecurity = охранная консоль заказа грузов
    .desc = Используется отделом милиции для заказа припасов.
...
ent-ComputerSupermatter = консоль мониторинга суперматерии
    .desc = Используется для отслеживания статуса суперматерии.
