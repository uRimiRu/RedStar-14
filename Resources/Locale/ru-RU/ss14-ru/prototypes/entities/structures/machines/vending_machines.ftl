...
ent-VendingMachineSec = СБТех
    .desc = Торговый автомат с экипировкой СБ. На табличке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ МИЛИЦИИ".
...
ent-VendingMachineGames = Безобидные развлечения
    .desc = Выдаёт вещи, которые капитан и начальник отдела кадров, скорее всего, не оценят, если вы будете развлекаться с ними вместо своей работы...
