...
ent-BarSignTheHarmbaton = Хармбатон
    .desc = Отличные обеды как для сотрудников милиции, так и для пассажиров.
...
ent-BarSignWhiskeyEchoes = Виски Эхо
    .desc = Элитный бар для элитных опер... Подождите, это же станция СССП. Почему эта вывеска в базе данных?
