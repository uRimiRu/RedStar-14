...
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как милиция или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях - милиция также может прослушивать канал связи Синдиката!
...
tips-dataset-46 = Будучи шахтёром, всегда носите с собой GPS и записывайте координаты станции на случай, если ваш обломок затеряется в космосе.
tips-dataset-47 = Будучи шахтёром, в крайнем случае вы можете использовать протокинетический ускоритель для передвижения в космосе. Просто знайте, что это не очень эффективно.
tips-dataset-48 = Будучи шахтёром, не забывайте копать руду! Руда может быть продана в карго за неплохие деньги, использована для строительства, а также научными сотрудниками для причудливых технологий.
tips-dataset-49 = Будучи шахтёром, попробуйте попросить научных сотрудников о гравипушке. Она может быть использована для экстремально эффективного передвижения объектов с обломков!
tips-dataset-50 = Будучи шахтёром, попробуйте попросить у научных сотрудников крюк-кошку. Его можно использовать для передвижения на обломков.
tips-dataset-51 = Совет #51 не существует и никогда не существовал. Игнорируйте любые слухи об обратном.
tips-dataset-52 = Будучи шахтёром, рассмотрите возможность сотрудничества с грузчиками. Они могут заказать для вас широкий ассортимент полезных предметов, включая те, которые может быть трудно получить иным способом, такие как лазерные пушки и материалы для строительства шаттлов.
tips-dataset-53 = Будучи грузчиком, попробуйте попросить научных сотрудников о Рипли АВП. В сочетании с гидравлической клешней, вы можете гораздо проще брать ценные предметы технического обслуживания, такие как топливные баки, и осуществлять доставку в кратчайшие сроки.
tips-dataset-54 = Будучи грузчиком, старайтесь поддерживать избыток материалов. Это чрезвычайно полезно, когда они срочно потребуются научным сотрудникам или инженерам.
...
tips-dataset-59 = Будучи агрономом, вы можете мутировать и скрещивать растения для создания более эффективных и урожайных сортов.
...
tips-dataset-62 = Будучи поваром, ваш нож может служить оружием в чрезвычайной ситуации.
tips-dataset-63 = Будучи поваром, вы можете тайно добавлять жидкости в свою еду. Как предатель, добавление небольшого количества аматоксина или другого яда может сильно навредить экипажу!
tips-dataset-64 = Будучи мимом помните, что ваш обет молчания - источник вашей силы. Нарушив его, вы лишитесь своих сил... и чести.
tips-dataset-65 = Занимаясь судебным делом, если наказание кажется вам слишком суровым, попытайтесь обсудить это со старшим следователем.
tips-dataset-66 = Будучи сотрудником милиции, общайтесь и координируйте свои действия с коллегами при помощи радиоканала милиции, чтобы избежать неразберихи.
tips-dataset-67 = Как сотрудник милиции помните — подозрений мало для обвинений. Возможно кто-то просто оказался не в том месте и не в то время!
tips-dataset-68 = Будучи следователем, вы можете более эффективно разыскивать преступников, опираясь на данные об оставленных им отпечатках пальцев и волокнах - сканируйте предметы с которым тот мог взаимодействовать.
...
tips-dataset-79 = Будучи научным сотрудником, вы можете попробовать различные вещи с артефактом, пока сканер перезаряжается, чтобы значительно ускорить процесс извлечения очков.
tips-dataset-80 = Будучи научным сотрудником, вы можете использовать детали машин получше для повышения эффективности машин. Это может сделать некоторые машины, такие как переработчик биомассы, значительно лучше!
tips-dataset-81 = Будучи научным сотрудником, вы можете делать боргов, используя позитронные мозги. Они так же полезны, как новый член экипажа.
...
tips-dataset-85 = Будучи врачом, помните, что в вашем анализаторе здоровья есть сменная батарея. Если, на ваш взгляд, батарея разряжается слишком быстро, вы можете попросить научных сотрудников напечатать для вас батарею получше!
...
tips-dataset-112 = Имея дело с милицией, вы часто можете избежать своего приговора за счёт сотрудничества или обмана.
...
tips-dataset-139 = Обязательно протирайте незаконные имплантеры мылом или тряпкой после их использования! Следователи могут сканировать использованные имплантеры на предмет наличия следов ДНК, но только в том случае, если те не были тщательно вытерты.
