...
ghost-role-information-deserter-description = "Меня уже заебало что заведующий хозяйством не выдаёт зарплату! Давайте угоним один из кораблей, помародёрим и заплатим себе сами."
ghost-role-information-deserter-rules =
    Вы не террорист, но и святым не назовёшь. Делайте всё, что нужно, чтобы "вернуть то, что флот нам задолжал".
