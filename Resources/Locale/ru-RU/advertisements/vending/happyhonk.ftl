...
advertisement-happyhonk-6 = Сколько офицеров милиции требуется чтобы арестовать вас? Трое: один чтобы избить вас до смерти, один чтобы надеть на вас наручники, и один чтобы оттащить ваше тело в техтоннель.
