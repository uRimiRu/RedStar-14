...
bounty-description-cuban-carp = В честь рождения Кастро XXVII отправьте одного карпа по-кубински в ГенШтаб.
bounty-description-donk-pocket = Отзыв о безопасности потребителей: Предупреждение. Донк-покеты, произведённые в прошлом году, содержат опасные биоматериалы ящериц. Немедленно верните продукты в ГенШтаб.
bounty-description-donut = Милиция Центкома несёт большие потери в борьбе с Синдикатом. Отправьте пончики для поднятия боевого духа.
...
bounty-description-pie = 3.14159? Нет! Руководство ГенШтаб хочет покушать ПИрогов! Отправьте им один.
...
bounty-description-soap = Из ванных комнат Центкома пропало мыло, и никто не знает, кто его взял. Замените его и станьте героем, в котором нуждается ГенШтаб.
...
bounty-description-spear = Милиция ГенШтаб переживает сокращение бюджета. Вам заплатят, если вы доставите набор копий.
...
bounty-description-trash = Недавно у группы уборщиков закончился мусор для уборки, а без мусора ГенШтаб хочет уволить их, чтобы сократить расходы. Отправьте партию мусора, чтобы сохранить им работу, и они дадут вам небольшую компенсацию.
...
bounty-description-vegetable = Новый повар — вегетарианец, и агрономы не справляются с его требованиями. Для поддержания запаса нам нужны дополнительные овощи.
bounty-description-chili = Сегодня Четверг Чили на ГенШтаб, но, ну, некоторые из нас забыли его приготовить. Пожалуйста, выручите нас.
bounty-description-rollerskates = Милиция ГенШтаб предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
...
bounty-description-banana = Привет, станция! агрономы не хотят мне больше ничего давать. Они сказали, что поскользнуть и выкинуть НМ в космос через открытый шлюз — это не смешно! Представляете? Помогите мне! ХОНК.
...
bounty-description-torch = Повар оживил всех обезьян и кобольдов разом, а они взбунтовались и захватили грузовой шаттл. Они потребовали припасов и безопасного перелёта на планету с джунглями, и мы уступили их требованиям. Теперь им нужно только несколько факелов.
bounty-description-medkit-box = ГенШтаб ставит спектакль в больнице, и нуждается в реквизите. Просто пришлите нам несколько пустых аптечек, и спектакль состоится!
...
bounty-description-wine = Новая библиотекарша и заведующий хозяйством влюбились друг в друга по уши после того, как она застала его за разборкой книжных полок на дрова. Пришлите пару бутылок вина (или банок, если хотите), чтобы свидание прошло удачно.
...
bounty-description-flashes = ПРИВЕТСТВИЕ \[Станция] НАМ НЕОБХОДИМЫ 6 ВСПЫШЕК ДЛЯ ОБЫЧНЫХ \[ТренировкаУпражнение] С СОТРУДНИКАМИ МИЛИЦИИ. ВСЁ \[Нормально].
