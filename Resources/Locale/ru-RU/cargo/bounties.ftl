...
bounty-description-artifact = СССП находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полёты. Верните один, и мы выплатим за него компенсацию.
bounty-description-baseball-bat = На Генеральном Штабе началась бейсбольная лихорадка! Будьте добры отправить им несколько бейсбольных бит, чтобы руководство могло исполнить свою детскую мечту.
...
bounty-description-carp = Адмирал Павлова объявила забастовку с тех пор, как Генеральный Штаб конфисковало её "питомца". Она требует заменить его космическим карпом, живым или мёртвым.
...
bounty-description-cuban-carp = В честь рождения Кастро XXVII отправьте одного карпа по-кубински на ГШ.
bounty-description-donk-pocket = Отзыв о безопасности потребителей: Предупреждение. Донк-покеты, произведённые в прошлом году, содержат опасные биоматериалы ящериц. Немедленно верните продукты Генеральному Штабу.
bounty-description-donut = Служба безопасности ГШ несёт большие потери в борьбе с Синдикатом. Отправьте пончики для поднятия боевого духа.
...
bounty-description-handcuffs = На Генеральный Штаб прибыл большой поток беглых заключённых. Сейчас самое время отправить запасные наручники (или стяжки).
...
bounty-description-knife = Один из наших лучших командиров недавно выиграл совершенно новый набор ножей на официальном игровом шоу СССП. К сожалению, у нас нет такого набора под рукой. Пришлите нам кучу острых предметов, чтобы мы могли что-нибудь придумать.
...
bounty-description-lung = Лига сторонников курения тысячелетиями боролась за то, чтобы сигареты оставались на наших станциях. К сожалению, их лёгкие уже не так сильно сопротивляются. Отправьте им новые.
bounty-description-monkey-cube = В связи с недавней генетической катастрофой, Генеральный Штаб испытывает острую потребность в обезьянах. Ваша задача — доставить обезьяньи кубы.
...
bounty-description-pancake = СССП считает всех своих сотрудников одной дружной семьёй. А вы знаете, что любят семьи? Блины. Отправьте дюжину.
...
bounty-description-pie = 3.14159? Нет! Оператор ГШ хочет покушать ПИрогов! Отправьте ему один.
...
bounty-description-research-disk = Оказывается, эти недоумки из отдела исследований тратят всё своё время на приобретение оборудования для уборки. Отправьте несколько исследований на Генеральный Штаб, чтобы мы могли действительно получить то, что нам нужно.
...
bounty-description-soap = Из ванных комнат Генерального Штаба пропало мыло, и никто не знает, кто его взял. Замените его и станьте героем, в котором мы так давно нуждались.
bounty-description-soup = Чтобы подавить восстание бездомных, СССП будет угощать супом всех малооплачиваемых работников. Отправьте любой вид супа.
bounty-description-spear = Служба безопасности ГШ переживает сокращение бюджета. Вам заплатят, если вы доставите набор копий.
...
bounty-description-toolbox = На Генеральном Штабе не хватает робастности. Поторопитесь и поставьте несколько ящиков с инструментами в качестве решения проблемы.
...
bounty-description-trash = Недавно у группы уборщиков закончился мусор для уборки, а без мусора Генеральный Штаб собирается уволить их, чтобы сократить расходы. Отправьте партию мусора, чтобы сохранить им работу, и они дадут вам небольшую компенсацию.
...
bounty-description-chili = Сегодня на ГШ Четверг Чили, но, ну... Некоторые из нас забыли его приготовить. Пожалуйста, выручите нас.
bounty-description-rollerskates = Служба безопасности ГШ предложила новую стратегию, которая поможет офицерам одерживать верх в пеших погонях. Пришлите им парочку, чтобы они поняли, насколько это ужасная идея.
bounty-description-bedsheet = В атмосферном отсеке кто-то постоянно выключает обогреватель, и мы все мёрзнем в наших кроватях. Пожалуйста, пришлите нам несколько дополнительных одеял, чтобы мы могли согреться.
...
bounty-description-torch = Шеф-повар оживил всех обезьян и кобольдов разом, а они взбунтовались и захватили грузовой шаттл. Захватчики потребовали припасов и безопасного перелёта на планету с джунглями, и мы уступили их требованиям. Теперь им нужно только несколько факелов.
bounty-description-medkit-box = Генеральный Штаб ставит спектакль в больнице, в связи с чем нуждается в реквизите. Просто пришлите нам несколько пустых аптечек, и спектакль состоится!
