...
borg-type-medical-desc = Оказывайте медицинскую помощь нуждающемуся экипажу в медотсеке или в опасных зонах, куда обычные фельдшеры не могут добраться.
borg-type-medical-transponder = борг-доктор
borg-type-service-name = Сервисный
borg-type-service-desc = Помогайте членам экипажа в самых разных ситуациях - от подачи закусок и напитков до занятий агрономией и развлечений.
