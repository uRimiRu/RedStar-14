...
delivery-spam-reasons-to-choose-syndicate =
    ...
    { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ СССП[/head]" }
...
delivery-spam-free-all-access = [head=3]Вы когда-нибудь мечтали о [italic][color=green]Бесссплатном [bold]Полном доссступе!?!?[/bold][/color][/italic][/head]
    ...
    { "[bullet/]Примечание: ООО Гоур-Лекссс не несёт ответственности, если ваш НОК узнает об этом письме и заставит вас заполнять НАСТОЯЩУЮ форму запроса на ПД" }
    { "[/color]" }
delivery-spam-centcomm-retribution = [color=red] ОФИЦИАЛНОЕ СООБЩЕНИЕ ГЛАВЫ [color=blue]НАНАТРАЗЕН[/color][/color]
    ...
    { "[head=2][italic] Нашей Великой и Славной [color=blue]СССП[/color][/head]" }
...
delivery-spam-alternate-timeline =
    ...
    { "[head=2]Это официальное уведомление [color=red]Начальника милиции[/color] Космической станции 15 Nanotrasen.[/head]" }
    
    Кому бы ни попало это письмо... Я сержант Ригель, начальник милиции. Нам срочно нужно подкрепление.
...
delivery-spam-rage-cage = [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color]
    ...
    Скрытая в глубинах станции СССП, запатентованная [color=#FF0000][bold]КЛЕТКА ЯРОСТИ[/bold][/color]! Эта электрифицированная арена создана только для сильнейших, в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] трусы отделяются от воинов, салаги — от солдат, а неудачники — от победителей.
    ──────────────────────────────────────────
...
delivery-spam-voyage-advertisement = [head=2]Присоединяйтесь к нам на первом рейсе...[/head]
    ...
    ░▀░▀░▀░▀░░░▀░░░▀▀▀░▀░▀░▀░▀░▀░▀░▀▀▀░▀▀▀░▀░░
     ...
     { "[head=3]Созерцайте Око Космоса**, наслаждаясь блюдами от наших поваров уровня Пяти Звёзд Галактики![/head]" }
    
     { "[head=3]Исследуйте руины Агатара***, теперь открытые для публики благодаря помощи лучших учёных СССП. Все тайны древней Агатарской цивилизации раскопаны и выставлены для вашего удовольствия![/head]" }
