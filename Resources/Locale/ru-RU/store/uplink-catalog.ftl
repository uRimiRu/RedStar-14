...
uplink-access-breaker-desc = Хороший друг емага. Это устройство способно принудительно открывать шлюзы, а также стирать требование доступа с оборудования станции. Перезаряжается автоматически.
...
uplink-business-card-desc = Визитная карточка, которую можно передать кому-нибудь, чтобы продемонстрировать свою принадлежность к Синдикату, или оставить на месте преступления, чтобы подшутить над следователем. Вы можете приобрести не более трёх таких визиток.
...
uplink-fake-mindshield-desc = Переключаемый имплант, способный имитировать те же сигналы, что испускает настоящий Щит разума, когда он включен, обманывая способные визоры, заставляя их думать, что у вас есть Щит разума (имплант марки СССП не предоставляется).
