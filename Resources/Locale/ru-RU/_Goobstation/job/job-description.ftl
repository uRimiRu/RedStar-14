...
job-description-navy-officer = Отвечайте на факсы и радиосообщения, направленные в Генеральный Штаб. Проводите расследования на станции и среди экипажа.
job-description-diplomat = Представляйте Генеральный Штаб, управляйте отношениями с другими фракциями на станции. Разбирайтесь с проблемами, которые, скорее всего, вызвал Капитан.
job-description-navy-special-operations-officer = Отправляйте, инструктируйте и направляйте Отряды Быстрого Реагирования или другие силы СССП. Выдайте ядерные коды или не делайте этого.
job-description-outercommander = Внешний наблюдатель, который инспектирует Генеральный Штаб и оказывает бюрократическое давление, не обладая прямой властью.
job-description-operations-officer = Отправляйте, инструктируйте и руководите Отрядами Быстрого Реагирования или другими силами СССП. Выпускайте ядерные коды — или нет.
...
job-description-mercenarycaptain = Отдавайте приказы другим наёмникам. Служите мышцами самому щедрому заказчику. То, что сейчас это СССП, не значит, что позже это не изменится.
