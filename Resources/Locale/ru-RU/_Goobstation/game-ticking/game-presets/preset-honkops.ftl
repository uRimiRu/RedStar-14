...
honkops-welcome =
    Вы - Хонк-оперативник. Ваша цель - взорвать { $station } и сделать так, чтобы от нее осталась лишь груда обломков. Ваши боссы, Хонкикат, снабдили вас снаряжением, которое понадобится для выполнения задания.
    Операция { $name } началась! Хонк!
honkops-briefing = Ваша задача проста. Доставьте заряд и обеспечьте его детонацию. Начинайте миссию. Хонк!
...
honkops-cond-nukeactiveatcentcom = ХОНКлеар бомба была доставлена в Генеральный Штаб!
