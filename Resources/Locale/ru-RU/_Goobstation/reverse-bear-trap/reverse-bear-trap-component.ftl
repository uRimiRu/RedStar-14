...
reverse-bear-trap-component-start-cuffing-by-other = { $otherName } насильно надевает капкан на вашу голову!
reverse-bear-trap-component-unlocked-trap-self = Вам удалось разблокировать капкан!
reverse-bear-trap-component-unlocked-trap-observer = { $user } успешно разблокировал капкан!
reverse-bear-trap-component-failed-unlocked-trap-self = Вам не удалось разблокировать капкан!
reverse-bear-trap-component-failed-unlocked-trap-observer = { $user } не смог разблокировать капкан!
reverse-bear-trap-component-trap-fall-observer = Капкан слетает с головы { $user }.
reverse-bear-trap-component-trap-fall-self = Капкан слетает с вашей головы.
reverse-bear-trap-component-trap-click-observer = Капкан щёлкает и захлопывается на голове { $user }!
...
reverse-bear-trap-component-start-unlocking-by-other = { $otherName } начинает разблокировать капкан на вашей голове!
