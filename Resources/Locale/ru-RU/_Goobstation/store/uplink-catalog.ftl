...
uplink-dualetta-bundle-desc = В комплекте 2 пистолета Дуалетта, 2 магазина, перчатки, нуарный костюм, тренч следователя и шнурованные ботинки.
...
uplink-second-skin-desc =
    Улучшенная версия устройства NanoTrasen милиции, которая не вызывает отвращения и не разъедает материалы роботов.
