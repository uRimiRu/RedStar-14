...
rmc-ui-lobby-message-description =
    ...
    Одно сообщение выбирается случайным образом из всех Патронов этого уровня.
...
rmc-ui-shoutout-nt-title = Имя для объявления СССП в конце раунда.
rmc-ui-shoutout-nt-description = Отображается в конце раунда как "СССП финансируется: " и ваше имя.
rmc-ui-shoutout-example = Пример:
rmc-ui-shoutout-info =
    Каждое имя выбирается случайным образом из всех Патронов этого уровня.
    Убедитесь, что выбранные имена в рамках ролевой игры и не нарушают правила.
    Если не уверены, спросите в AHelp! (F1)
rmc-ui-save = Сохранить
rmc-ui-ghost-color = Цвет призрака
rmc-ui-ghost-color-clear = Очистить
rmc-ui-ghost-color-save = Сохранить
rmc-ui-shoutout-nt = [bold]СССП финансируется: [color=green]{ $name }[/color]![/bold]
