...
cmd-announce-help = { $command } <сообщение> [отправитель] [цвет] [звук] - Отправить объявление. По умоланию отправитель - Генеральный Штаб, цвет - золотой, звук - announce.ogg. Цвет должен быть в #RRGGBB формате.
