...
cosmiccult-elimination-announcement = Согласно сканированию дальнего радиуса, аномалия Лямбда-CDM угасла. Благодарим вас за проявленную бдительность. Эвакуационный шаттл был вызван. Возвращайтесь на станцию Генерального Штаба.

## BRIEFINGS

cosmiccult-role-roundstart-fluff =
    Пока вы готовитесь к ещё одной смене на очередной станции СССП, в ваш разум врывается поток неисчислимых запретных знаний!
