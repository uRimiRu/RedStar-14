...
ent-ActionRegenerativeStasis = Regenerative Stasis
    .desc = Prepare/leave regenerative stasis. Costs 15 chemicals to leave.
ent-ActionRegenerate = Regenerate
    .desc = Regenerate missing limbs, restore blood, stop bleeding, fix wounds and repair broken bones. Costs 15 chemicals.
...
ent-ActionChameleonSkin = Chameleon Skin
    .desc = Slowly blend in with the environment. Costs 20 chemicals.
...
ent-ActionFleshmend = Fleshmend
    .desc = Rapidly heal yourself. Costs 30 chemicals.
